...
})({"kuUEA":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "1b702b4e0ef871c1";
"use strict";
...
},{}],"qEZ78":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "_", function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jstvy"}],"42yWO":[function(require,module,exports) {
/* 
* <license header>
*/ /* global fetch */ /**
 *
...
function _actionWebInvoke() {
    _actionWebInvoke = (0, _asyncToGenerator._)(function(actionUrl) {
        var headers, params, options, actionHeaders, fetchConfig, response, content;
        var _arguments = arguments;
        return (0, _tsGenerator._)(this, function(_state) {
            switch(_state.label){
                case 0:
                    headers = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : {}, params = _arguments.length > 2 && _arguments[2] !== void 0 ? _arguments[2] : {}, options = _arguments.length > 3 && _arguments[3] !== void 0 ? _arguments[3] : {
                        method: "POST"
                    };
                    actionHeaders = (0, _objectSpread._)({
                ...
                case 2:
                    content = _state.sent();
                    if (!response.ok) throw new Error("failed request to '".concat(actionUrl, "' with status: ").concat(response.status, " and message: ").concat(content));
                    try {
...
},{"@swc/helpers/_/_async_to_generator":"koFeh","@swc/helpers/_/_object_spread":"2PEPa","@swc/helpers/_/_ts_generator":"qEZ78","@parcel/transformer-js/src/esmodule-helpers.js":"jstvy"}],"2PEPa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jstvy"}]},["kuUEA","42yWO"], "42yWO", "parcelRequire8db1")

//# sourceMappingURL=index.0ef871c1.js.map
