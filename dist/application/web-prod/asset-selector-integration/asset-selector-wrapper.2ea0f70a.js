...
function init() {
    ...
    function renderAssetSelectorWithAuthFlow(props) {
        ...
        var assetsSelectorsProps = {
            onClose: onClose,
            handleSelection: handleSelection,
            env: defaultImsAuthInfo.env === "stg1" ? "stage" : "prod",
            imsOrg: defaultImsAuthInfo.imsOrg || null
        };
        var container = document.getElementById("asset-selector-dialog-content");
        PureJSSelectors.renderAssetSelectorWithAuthFlow(container, assetsSelectorsProps, function() {
    ...
    function _handleSelection() {
        _handleSelection = _async_to_generator(function(assets) {
            var onAssetsSelectedEvent;
            return _ts_generator(this, function(_state) {
                onAssetsSelectedEvent = new CustomEvent("onAssetsSelectedEvent", {
                    detail: assets
                });
...
//# sourceMappingURL=asset-selector-wrapper.2ea0f70a.js.map
