...
describe('page/index.js', () => {
    ...
    it('correctly sets up the connection with module-runtime', () => {
        ...
        const reloadSandboxSpy = jest.spyOn(Global_1.default['exc-module-runtime'].page, 'reloadSandbox');
        page_1.default.reloadSandbox();
        expect(reloadSandboxSpy).toBeCalledTimes(1);
